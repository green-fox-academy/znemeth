...
int main(void)
{
	...
	TimHandle3.Init.Period = 24000 - 1; /* 10000 x 0.1 ms = 1 second period */
	TimHandle3.Init.ClockDivision = TIM_CLOCKDIVISION_DIV1;
	TimHandle3.Init.CounterMode = TIM_COUNTERMODE_UP;

	TimHandle4.Instance = TIM4;
	TimHandle4.Init.Prescaler = 54000 - 1; /* 108000000/10800=10000 -> speed of 1 count-up: 1/10000 sec = 0.1 ms */
	TimHandle4.Init.Period = 24000 - 1; /* 10000 x 0.1 ms = 1 second period */
	...
	while (1) {
		...
		// GREEN
		tim_val4 = __HAL_TIM_GET_COUNTER(&TimHandle4);
		if (tim_val4 == 0) {
